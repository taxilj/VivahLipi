  ...
  return (
    <div className="min-h-screen bg-cream flex flex-col items-center justify-center px-6 py-12">
      ...
      <div className="w-full max-w-sm bg-white border border-gold/30 rounded-3xl p-8 shadow-card">
        <h1 className="font-serif text-2xl font-bold text-charcoal mb-1 text-center">Create Account</h1>
        ...
        <button
          onClick={() => {}}
          className="w-full flex items-center justify-center gap-3 rounded-full border border-gold/30 bg-white py-3 px-4 text-sm font-medium text-charcoal hover:bg-cream transition-all"
        >
        ...
        <div className="text-center text-xs text-muted mt-4">Your data is safe 🔒</div>
      </div>
      ...
      <Link href="/" className="text-xs text-muted mt-4 hover:text-charcoal transition-colors">
        ← Back to Home
      </Link>
    </div>
  )
