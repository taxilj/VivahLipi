    ...
    return (
      <div className="min-h-screen bg-cream flex flex-col items-center justify-center px-6">
        <div className="text-center max-w-sm">
          ...
          <h1 className="font-serif text-2xl font-bold text-charcoal mb-2">Magic Link Sent!</h1>
          <p className="text-sm text-muted mb-6">
            Check your inbox at <strong className="text-charcoal">{email}</strong> and click the link to continue.
          </p>
          <button
  ...
  return (
    <div className="min-h-screen bg-cream flex flex-col items-center justify-center px-6 py-12">
      ...
      <div className="w-full max-w-sm bg-white border border-gold/30 rounded-3xl p-8 shadow-card">
        <h1 className="font-serif text-2xl font-bold text-charcoal mb-1 text-center">Get Started</h1>
        <p className="text-sm text-muted text-center mb-8">Enter your email to receive a magic link</p>
